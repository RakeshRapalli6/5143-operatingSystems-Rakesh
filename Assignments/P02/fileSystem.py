...
class FileSystem:
    ...
    """
    This function mimicks the command chmod which changes the permissions of a file.The way it does it here based on the
    helper function permission.py where the permissions are modified based upon the triple digit number we as the input
    for a specified file and now we update the table with this new permission that we got.
    """
